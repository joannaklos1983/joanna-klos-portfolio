...
export default function Home() {
  const steps: [string, string, string[], string[]][] = [
    ...
    ["04", "Wdrażam rozwiązania", ["Pomagam przejść od planu do realizacji i koordynuję działania projektowe."], ["aktualizacja stron WordPress i CMS", "publikacja treści", "koordynacja projektów marketingowych", "współpraca z grafikami i wykonawcami", "organizacja wydarzeń i inicjatyw marketingowych"]],
